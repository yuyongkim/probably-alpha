...
export default function Page() {
  return (
    <div>
      <div className="breadcrumb">Execute <span className="sep">/</span> <span className="current">알고리즘 주문</span></div>
      <div className="page-header">
        <div className="page-title-group">
          <h1>알고리즘 주문</h1>
          <div className="page-meta">TWAP · VWAP · ICEBERG · SNIPER · KIS ALGO API</div>
        </div>
      </div>
      <div className="stub">
