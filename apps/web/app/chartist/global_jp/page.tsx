...
export default function Page() {
  return (
    <div>
      <div className="breadcrumb">Chartist <span className="sep">/</span> Global <span className="sep">/</span> <span className="current">JP Leaders</span></div>
      <div className="page-header">
        <div className="page-title-group">
          <h1>JP Leaders · Nikkei 225</h1>
          <div className="page-meta">KIS 해외주식 · 엔저 수혜주</div>
        </div>
      </div>
      <div className="stub">
