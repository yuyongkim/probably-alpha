...
export default function Page() {
  return (
    <div>
      <div className="breadcrumb">Chartist <span className="sep">/</span> Global <span className="sep">/</span> <span className="current">HK / CN Leaders</span></div>
      <div className="page-header">
        <div className="page-title-group">
          <h1>HK / CN Leaders · HSI + CSI 300</h1>
          <div className="page-meta">KIS 해외주식 · 정책 리스크 Stop 타이트</div>
        </div>
      </div>
      <div className="stub">
