import { escapeHtml, fmtDate, fmtNum, state } from '../core.js?v=1775482261';
import { txt } from '../i18n.js?v=1775482261';
import { renderPaginatedMarkup } from './pagination.js?v=1775482261';
import {
  backtestSessionMarkup,
  bucketWindowLabel,
  buildSectorContext,
  companyMarkup,
} from './shared.js?v=1775482261';
